...
class StandardAminoAcidsTestCase(unittest.TestCase):
    ...
    def test_key_length(self):
        ...
        key_lengths = [
            len(k) for k in amino_acids.standard_amino_acids.keys()]
    ...
    def test_value_length(self):
        ...
        val_lengths = [
            len(v) for v in amino_acids.standard_amino_acids.values()]
...
class AACodeTestCase(unittest.TestCase):
    ...
    def test_aa_code_invalid(self):
        self.assertIsNone(amino_acids.get_aa_code(
            'testingnonsensestring'))
...
class AALetterTestCase(unittest.TestCase):
    ...
    def test_aa_letter_invalid(self):
        self.assertEqual(amino_acids.get_aa_letter(
            'longstringofletters'), 'X')
...
class AminoAcidDictTestCase(unittest.TestCase):
    ...
    def test_standard_amino_acids(self):
        ...
        standards = [x['letter'] for x in amino_acids.AMINO_ACIDS_DATA.values(
        ) if x['letter'] != "X"]
    ...
    def test_unexpected_letters(self):
        ...
        self.assertEqual(len(
            [x for x in amino_acids.AMINO_ACIDS_DATA.values() if x['letter'] in unexpected_letters]), 0)
...
class GetAAInfoTestCase(unittest.TestCase):
    ...
    def test_nonsense_code(self):
        self.assertRaises(
            IOError, amino_acids.get_aa_info, code="nonsensecode")
...
class AddAminoAcidToJsonTestCase(unittest.TestCase):
    ...
    def test_exisitng_amino_acid(self):
        self.assertRaises(IOError, amino_acids.add_amino_acid_to_json,
